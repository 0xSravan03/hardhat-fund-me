...
describe("FundMe", function () {
    ...
    describe("withdraw", function () {
        ...
        it("allow owner to withdraw fund if there are multiple funders", async function () {
            ...
            for (let i = 1; i <= 5; i++) {
                const newContractInstance = await fundMe.connect(accounts[i]) // connecting each account with fundMe contract
            ...
            await expect(fundMe.funders(0)).to.be.reverted // checking if the funders array is resetted after withdrawing amount
